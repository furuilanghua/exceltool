...
def dataframe_agent(openai_api_key, df, query):
    model = ChatOpenAI(model="deepseek-reasoner",
...
#model = ChatOpenAI(model="deepseek-reasoner",openai_api_key=openai_api_key,temperature=0,base_url=("https://api.deepseek.com"))